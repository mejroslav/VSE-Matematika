...
\subsubsection*{Integrály typu $\int \frac{f'(x)}{f(x)}\, \D x$}
...
Viděli jsme, že metoda substituce potřebuje \uv{zkušené oko} - k jejímu ovládnutí je potřeba propočítat mnoho typových úloh.
